...
import { Card, CardContent, Grid, LinearProgress, TextField, InputAdornment, IconButton, Button, Box, Slider, Typography, Paper } from '@mui/material';
...
function Sweing() {
    ...
    let get_session = sessionStorage.getItem("article_data"); // or sessionStorage
    ...
    const handleInputChange = (e) => {
        ...
        setGet_session_user((prev) => {
            ...
            sessionStorage.setItem("article_data", JSON.stringify(updatedUser));
    ...
    return (
        ...
        >
            <div className='sweing-card' style={{ background: 'linear-gradient(145deg, #f0f4f8 0%, #e6eaf0 100%)' }}>
      ...
      {testingData && <pre>{JSON.stringify(testingData, null, 2)}</pre>} */}
                <Card>
                    <CardContent style={{ boxShadow: `none !important`, backgroundColor: `#fff` }}>
                        ...
                        {/* Top Area */}
                        <Grid container spacing={2} columns={12} columnSpacing={15}>
                        ...
                        <Grid container spacing={2} columns={12} columnSpacing={15} mt={1}>
                        ...
                        {/* Inputs Area */}
                        <Grid container spacing={3} columns={12} columnSpacing={15} style={{ marginTop: '20px' }}>
                            ...
                            <Grid item md={4}>
                                <Typography>Section 1-min</Typography>
                                <TextField
                                    fullWidth
                                    // label="Section 1-min."
                                    variant="outlined"
                            ...
                            <Grid item xs={4}>
                                <Typography>Section 1-max</Typography>
                                <TextField
                                    fullWidth
                                    // label="Section 1-max."
                                    variant="outlined"
                            ...
                            <Grid item xs={4}>
                                <Typography>Section 1-Stitches</Typography>
                                <TextField
                                    fullWidth
